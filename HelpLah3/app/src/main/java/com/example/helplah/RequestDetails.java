            ...
            public void onClick(View view) {
                ...
                alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK, NP", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        JsonObjectRequest acceptRequest = new JsonObjectRequest(Request.Method.POST, ACCEPT_REQUEST_URL, null, null, null){
                            @Override
                            protected Map<String, String> getParams() throws AuthFailureError {
                                Map<String, String> params = new HashMap<String, String>();
                                params.put("acceptId", String.valueOf(mainActivity.userID));
                        ...
                        VolleyQueueSingleton.getInstance(RequestDetails.this).addToRequestQueue(acceptRequest);
